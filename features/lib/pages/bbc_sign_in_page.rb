...
class BbcSignInPage
  ...
  WRONG_USERNAME_ERROR_TEXT = 'Sorry, we can’t find an account with that username. If you\'re over 13, try your email address instead or ' unless const_defined?(:WRONG_USERNAME_ERROR_TEXT)
  ...
  WRONG_PASSWORD_ERROR_ID = 'form-message-password' unless const_defined?(:WRONG_PASSWORD_ERROR_ID)
